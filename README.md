...
a Variational Autoencoder to produce predictive geometries conditioned on 
experimental data.

`PyTorch` `PyTorch Geometric` `RDKit` `Psi4` `VAE` `Python`

🔗 [github.com/mw00847/molecular_interactions](https://github.com/mw00847/molecular_interactions)
...
FTIR data and applied supervised ML to model tank lifetime. Used targeted DFT and 
vibrational analysis to characterise molecular structures and interpret degradation 
pathways. Delivered via a Streamlit application for non-technical colleagues.

`scikit-learn` `Psi4` `PySCF` `Streamlit` `Pandas` `Python`
...
`Pandas` `scikit-learn` `Streamlit` `Git` `Python`
...
`GROMACS` `MARTINI` `Gaussian` `Materials Studio` `Python` `HPC`

📄 [Progress in Organic Coatings — doi:10.1016/j.porgcoat.2022.107065](https://doi.org/10.1016/j.porgcoat.2022.107065)

---

## Tools & Frameworks

**ML/Python:** PyTorch, PyTorch Geometric, scikit-learn, Pandas, NumPy, Streamlit  
**Simulation:** GROMACS, MARTINI forcefield, OpenMM, Materials Studio  
**Quantum Chemistry:** Psi4, PySCF, Gaussian  
**Cheminformatics:** RDKit  
**Infrastructure:** Linux, HPC/SLURM, Git, Bash scripting  
